...
namespace IBaseFramework.Helper
{
    public class SecurityHelper
    {
        ...
        /// <returns></returns>
        private static Task<string> HashEncrypt(HashAlgorithm hashAlgorithm, string input, Encoding encoding)
        {
            var data = hashAlgorithm.ComputeHash(encoding.GetBytes(input));

            return Task.FromResult(BitConverter.ToString(data).Replace("-", ""));
        }
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Md5Encrypt(string input, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Sha1Encrypt(string input, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Sha256Encrypt(string input, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Sha384Encrypt(string input, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Sha512Encrypt(string input, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Hmacsmd5Encrypt(string input, string key, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Hmacsha1Encrypt(string input, string key, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Hmacsha256Encrypt(string input, string key, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Hmacsha384Encrypt(string input, string key, Encoding encoding)
        {
        ...
        /// <param name="encoding"> 字符编码 </param>
        /// <returns></returns>
        public static Task<string> Hmacsha512Encrypt(string input, string key, Encoding encoding)
        {
        ...
        /// <returns></returns>
        public static Task<string> DesEncrypt(string input, string key)
        {
            try
            {
        ...
        /// <param name="key"> 密钥（8位） </param>
        /// <returns></returns>
        public static Task<string> DesDecrypt(string input, string key)
        {
            try
            {
                var keyBytes = Encoding.UTF8.GetBytes(key);
        ...
        public static Task<string> RsaEncrypt(string publickey, string content)
        {
        ...
        public static Task<string> RsaDecrypt(string privatekey, string content)
        {
            var rsa = new RSACryptoServiceProvider();
            rsa.FromXmlString(privatekey);
            var cipherbytes = rsa.Decrypt(Convert.FromBase64String(content), false);

            return Task.FromResult(Encoding.UTF8.GetString(cipherbytes));
        }
