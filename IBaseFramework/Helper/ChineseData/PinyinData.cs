namespace IBaseFramework.Helper.ChineseData
{
    public static class PinyinData
    {
        public static char MinValue = (char)19968;

        public static char MaxValue = (char)40869;

        public static string Pinyin12295 = "LING";

        public static char Char12295 = (char)12295;

        public static int PinyinCode1Offset = 7000;

        public static int PinyinCode2Offset = 7000 * 2;

        public static int[] BitMasks = new[] { 1, 2, 4, 8, 16, 32, 64, 128 };

        public static short PaddingMask = 256;

        public static string[] PinyinTable = new[]{"", "A", "AI", "AN", "ANG", "AO", "BA", "BAI",
