...
namespace IBaseFramework.Helper
{
    ...
    public class ValidateCodeHelper
    {
        ...
        private static readonly string[] FontFamilies = { "Arial", "宋体", "黑体" };
        private static readonly string[] Operators = { "+", "-", "×" };
        private static readonly FontStyle[] FontStyles = { FontStyle.Bold, FontStyle.Italic, FontStyle.Regular };

        public ValidateCodeHelper(VCodeType type, int length)
        {
            _vcodeType = type;
            _length = length;
        }
        ...
        {
            var random = RandomHelper.Random();
            var fontFamily = new FontFamily(FontFamilies[random.Next(FontFamilies.Length - 1)]);
