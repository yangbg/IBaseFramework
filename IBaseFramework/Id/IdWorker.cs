...
namespace IBaseFramework.Id
{
    ...
    {
        //基准时间
        internal const long Twepoch = 1288834974657L;
        //机器标识位数
        ...
        internal long DatacenterId { get; set; }
        /*
        ...
        */
        ...
        internal IdWorker(long workerId, long datacenterId, long sequence = 0L)
        {
            // 如果超出范围就抛出异常
